...
export const translations: Record<Lang, Dict> = {
  'pt-BR': {
    ...
    'menu.erroExportar': 'Não foi possível exportar o arquivo.',
    ...
    'form.valorEhTotalOuParcela': 'O valor digitado é:',
    'form.valorTotalCompra': 'Total da compra',
    'form.valorDaParcela': 'Valor de cada parcela',
    'form.previewValorParcela': '{valor} por parcela',
    ...
    'tabela.acoes': 'Ações',
    'tabela.pago': 'Pago',
    'tabela.marcarPago': 'Marcar como pago',
    'tabela.recebido': 'Recebido',
    'tabela.marcarRecebido': 'Marcar como recebido',
    'resumo.recebido': 'Recebido',
    'resumo.pagoTotal': 'Pago',
    'resumo.saldoReal': 'Saldo real',
    'resumo.jaRealizado': 'Já realizado',
    'resumo.aReceber': 'A receber',
    'resumo.aPagar': 'A pagar',
  ...
  en: {
    ...
    'menu.erroExportar': 'Could not export the file.',
    ...
    'form.valorEhTotalOuParcela': 'The amount entered is:',
    'form.valorTotalCompra': 'Total purchase amount',
    'form.valorDaParcela': 'Amount per installment',
    'form.previewValorParcela': '{valor} per installment',
    ...
    'tabela.pago': 'Paid',
    'tabela.marcarPago': 'Mark as paid',
    'tabela.recebido': 'Received',
    'tabela.marcarRecebido': 'Mark as received',
    'resumo.recebido': 'Received',
    'resumo.pagoTotal': 'Paid',
    'resumo.saldoReal': 'Actual balance',
    'resumo.jaRealizado': 'Already settled',
    'resumo.aReceber': 'To receive',
    'resumo.aPagar': 'To pay',
  ...
  es: {
    ...
    'menu.exportarJson': 'Exportar JSON',
    'menu.exportarCsv': 'Exportar CSV',
    'menu.erroExportar': 'No se pudo exportar el archivo.',
    ...
    'form.valorEhTotalOuParcela': 'El monto ingresado es:',
    'form.valorTotalCompra': 'Total de la compra',
    'form.valorDaParcela': 'Monto de cada cuota',
    'form.previewValorParcela': '{valor} por cuota',
    ...
    'tabela.pago': 'Pagado',
    'tabela.marcarPago': 'Marcar como pagado',
    'tabela.recebido': 'Recibido',
    'tabela.marcarRecebido': 'Marcar como recibido',
    'resumo.recebido': 'Recibido',
    'resumo.pagoTotal': 'Pagado',
    'resumo.saldoReal': 'Saldo real',
    'resumo.jaRealizado': 'Ya realizado',
    'resumo.aReceber': 'Por recibir',
    'resumo.aPagar': 'Por pagar',
